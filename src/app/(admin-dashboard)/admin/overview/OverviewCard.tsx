...
import { useGetAiStatusCardQuery } from "@/redux/features/adminOverView/adminUserSlice";
      ...
      {data.map((item, i) => (
        ...
        >
          <div className="flex flex-col gap-2">
            <span className="text-xl md:text-[42px] font-bold text-zinc-800">
              {item.value}
            </span>
          ...
          <div className="flex flex-col gap-3">
            <Image src={item.image} alt="icons" height={56} width={56} />
