  ...
  const [categories, setCategories] = useState<Category[]>([
    {
      ...
      options: [
        ...
        { id: "ΑΔΕΙΑ_ΜΙΚΡΗΣ_ΚΑΙΜΑΚΑΣ_ΑΛΛΑΦ_ΧΡΗΣΗΣ_1", label: "Εργασίες άλλης χρήσης_1" },
        {
          id: "ΑΔΕΙΑ_ΜΙΚΡΗΣ_ΚΑΙΜΑΚΑΣ_ΔΑΧΤΥΛΙΔΙΩΝ_ΟΠΙΣΘΙΟΠΟΙΗΣΗΣ_ΙΟΚΘΕΙΑΣ_5",
          label: "Εργασίες χρωματισμών & επισκευών με χρήση ικριωμάτων_5",
          selected: true,
        },
        { id: "ΑΔΕΙΑ_ΜΙΚΡΗΣ_ΚΛΙΜΑΚΑΣ_ΤΟΠΟΘΕΤΗΣΗ_ΙΚΡΙΩΜΑΤΩΝ_15", label: "Τοποθέτηση ικριωμάτων_15" },
        {
        ...
        { id: "ΑΔΕΙΑ_ΜΙΚΡΗΣ_ΚΑΙΜΑΚΑΣ_ΑΝΑΚΑΤΑΣΚΕΥΗ_ΥΠΕΡΗΧΩΝ_2", label: "Ανακατασκευή στέγης_2" },
      ],
    },
    {
      id: "energy-systems",
    ...
    },
    {
      ...
      options: [
        {
          id: "ΑΔΕΙΑ_ΜΙΚΡΗΣ_ΚΑΙΜΑΚΑΣ_ΠΙΣΙΝΑ_COMPACT_ΕΩΣ_50_Τ.Μ._13",
          label: "Κατασκευή ασκεπούς δεξαμενής ή πισίνας COMPACT μέχρι 50 τ.μ._13",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      options: [
        ...
        },
        {
          ...
          label: "Περίφραξη με πρόχειρη κατασκευή σε μη ρυμοτομ. εντός σχεδίου_12",
        },
      ],
    },
    {
      ...
      icon: <FileText size={20} className="text-indigo-600" />,
      options: [
        { id: "ΑΔΕΙΑ_ΜΙΚΡΗΣ_ΚΑΙΜΑΚΑΣ_ΔΑΧΤΥΛΙΔΙΩΝ_ΟΠΙΣΘΙΟ_4", label: "Λειτουργική συνένωση χώρων_4" },
      ],
    },
  ]);
