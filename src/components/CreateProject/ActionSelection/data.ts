...
export const templateName: TemplateName[] = [
    ...
    // Ενημερωτικό Σημείωμα Σχεδίων Όψεων
    // Πίνακας 3(ΙΚΑ)
    // ΣΑΥ – ΦΑΥ(Σχέδιο & Φάκελος Ασφάλειας & Υγείας)
    // ΣΔΑ(Σχέδιο Διαχείρισης Αποβλήτων)
    // ΥΔ Ανάθεσης Επίβλεψης Ιδιοκτήτη
    // ΥΔ Ανάθεσης Ιδιοκτήτη
    // ΥΔ Ανάληψης Επίβλεψης Έργου Μηχανικού
    // ΥΔ Ανάληψης Έργου Μηχανικού
    // ΥΔ μη ύπαρξης ΑΕΚΚ_ΣΔΑ Μηχανικού 
    // Υπόδειγμα Συναίνεσης Συνιδιοκτητών
    // Τεχνική Έκθεση / Βεβαίωση Μηχανικού
];
