...
export default function F13D5({ allData }: { allData: allDataProps }) {
    const {
        owner_address,
        owner_afm,
        owner_birth_date,
      ...
      <div className="border border-gray-400">
        ...
        <div className="p-4 text-sm space-y-6">
          <p className="font-bold">
            Η κατασκευή της δεξαμενής (λεκάνη, πλευρικά τοιχώματα, πυθμένας) έχει μελετηθεί στατικά, ώστε να διασφαλίζεται
            η επάρκεια και ασφάλειά της υπό όλα τα προβλεπόμενα φορτία, συμπεριλαμβανομένων:
          </p>
          <p>-Φορτίων υδροστατικής πίεσης πλήρωσης με νερό,</p>
          <p>-Φορτίων εδαφικών ωθήσεων,</p>
          <p>-Ιδίου βάρους της κατασκευής,</p>
          <p>-Πρόσθετων φορτίων χρήσης και συντήρησης.</p>

          <p className="font-bold">
            Η στατική μελέτη που εκπονήθηκε τηρεί τις απαιτήσεις των Ευρωκωδίκων και των σχετικών κανονισμών, καθώς και τους ισχύοντες
            κανονισμούς οπλισμένου σκυροδέματος (ΚΑΝ.ΕΠΕ, EC2).
          </p>
          <p>
            Κατά την υλοποίηση των εργασιών θα ληφθούν όλα τα απαραίτητα μέτρα ασφάλειας, σύμφωνα με τη νομοθεσία περί προστασίας εργαζομένων και τρίτων (ΠΔ 305/1996 κ.λπ.).                                             Η παρούσα δήλωση υποβάλλεται για τις ανάγκες του φακέλου Άδειας Μικρής Κλίμακας,
             σύμφωνα με τις διατάξεις του Ν.4495/2017, καθώς και των λοιπών ισχυουσών πολεοδομικών και τεχνικών διατάξεων.
          </p>
        </div>
