...
export default function F1D2({ allData }: { allData: allDataProps }) {
    ...
    return (
        <div className="max-w-[794px] mx-auto p-6 bg-white">
            ...
            <div className="space-y-6 ml-10">
                ...
                <div>
                    <h3 className="text-sm font-bold underline mb-6">Ωστόσο, στη συγκεκριμένη περίπτωση, για το σύνολο των προβλεπόμενων εργασιών, διαπιστώνεται ότι οι διαρρυθμίσεις δεν τροποποιούν τις εγκεκριμένες μελέτες του κτιρίου και ιδίως δεν επηρεάζουν:</h3>
                </div>
                <div>
                    <h3 className="text-sm font-bold underline mb-6">Τη μελέτη ενεργητικής πυροπροστασίας</h3>
                    <p className="text-sm mb-12">Ως εκ τούτου, δεν απαιτείται η κατάθεση νέων ή τροποποιημένων μελετών για την ενημέρωση του φακέλου της οικοδομικής άδειας. Το παραπάνω επιβεβαιώνεται και από τις διατάξεις της παρ. 10 του άρθρου 42 του Ν.4495/2017, σύμφωνα με τις οποίες δεν απαιτείται επικαιροποίηση μελετών για διαρρυθμίσεις που δεν επηρεάζουν τα συστήματα πυροπροστασίας ή τις Η/Μ εγκαταστάσεις.</p>
                </div>
