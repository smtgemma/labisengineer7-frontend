...
export default function F1D9({ allData }: { allData: allDataProps }) {
  const {
    owner_address,
    owner_afm,
    owner_birth_date,
  ...
  return (
    <div className="max-w-[794px] mx-auto p-4 bg-white">
      ...
      <div className="border border-gray-400">
        ...
        <div className="p-4 text-sm">
          από την ανάλυση του συνόλου των προβλεπόμενων εργασιών προκύπτει{" "}
          <span className="text-sm font-semibold">
            ότι δεν πραγματοποιούνται επεμβάσεις σε φέροντα στοιχεία του οργανισμού του κτιρίου.
          </span>
          ...
          <div className="flex justify-end p-4">
            <div className="text-right space-y-2">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm font-medium">6/25/2025</span>
              </div>
