    ...
    return (
        <div className="max-w-[794px] mx-auto p-6 bg-white">
            ...
            <div className="space-y-6 ml-10">
                ...
                <div>
                    <h3 className="text-sm font-bold underline">Άρθρο 4, ΥΑ ΦΕΚ Β' 1843/2020</h3>
                </div>

                <div>
                    <h3 className="text-sm font-bold">1. Αντικείμενο Εργασιών </h3>
                    <p className="text-sm mb-6">
                        Η παρούσα τεχνική έκθεση αφορά την ανακατασκευή της υφιστάμενης στέγης του κτιρίου, σύμφωνα με τις προβλέψεις του άρθρου
                        4 της ΥΑ ΦΕΚ Β' 1843/2020 και τις διατάξεις του Ν.4495/2017 περί έκδοσης Άδειας Μικρής Κλίμακας.
                    </p>

                </div>

                <div>
                    <h3 className="text-sm font-bold">2. Αναγκαιότητα Εργασιών

                    </h3>
                    <p className="text-sm mb-6">
                        Η ανάγκη εκτέλεσης των εργασιών προκύπτει λόγω της προχωρημένης φθοράς και παλαιότητας της υφιστάμενης στέγης, καθώς έχουν παρατηρηθεί εκτεταμένες φθορές στα υλικά επικάλυψης (π.χ. κεραμίδια), στο φέρον ξύλινο σκελετό, καθώς και σε στοιχεία στεγανοποίησης και υδρορροών. Επιπλέον, έχουν εντοπιστεί διαρροές υγρασίας στους υπερκείμενους χώρους του
                        κτιρίου, οι οποίες χρήζουν άμεσης αποκατάστασης για λόγους ασφάλειας, υγιεινής και διατήρησης της δομικής ακεραιότητας.
                    </p>

                </div>

                <div>
                    <h3 className="text-sm font-bold">3. Δήλωση Συμμόρφωσης – Πολεοδομική Νομιμότητα

                    </h3>
                    <p className="text-sm mb-6">
                        Δηλώνεται ότι οι παραπάνω εργασίες:
                    </p>
                    <p className="text-sm my-3">● Δεν θίγουν ή τροποποιούν τον φέροντα οργανισμό του κτιρίου</p>
                    <p className="text-sm my-3">● Δεν αυξάνουν τον όγκο, το ύψος ή τη γεωμετρία της στέγης</p>
                    <p className="text-sm my-3">● Δεν παραβιάζουν τις ισχύουσες πολεοδομικές διατάξεις</p>

                    <h3 className="text-sm font-bold my-3">Εκτελούνται σύμφωνα με το άρθρο 29 του Ν.4495/2017 και το άρθρο 4 <br /> της ΥΑ ΦΕΚ Β’ 1843/2020.</h3>
