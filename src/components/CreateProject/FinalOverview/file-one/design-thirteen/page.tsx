    ...
    <div className="max-w-[796px] mx-auto px-12 pt-18 pb-2 bg-white">
      <div className=" bg-white">
        ...
        <div className="grid grid-cols-12 gap-2 mb-4 ml-10">
          ...
          <div className="col-span-8">PROJECT DESCRIPTION</div>
        </div>
        ...
        <div className="mt-[100px]">
          <p className="mt-6 mb-2">
            Εμείς οι κάτωθι υπογεγραμμένοι, συνιδιοκτήτες της πολυκατοικίας επί
            της οδού
          </p>
          <h3>
          ...
          <p>
            δηλώνουμε υπεύθυνα και ρητά συναινούμε στην εκτέλεση των παρακάτω
            εργασιών:
          </p>
        </div>
        ...
        <div className="mt-4">
          <p className="font-semibold text-sm my-6">
            [WORKS FROM TECHNICAL DESCRIPTION]
          </p>
          <p className="text-sm ">
            Η συναίνεση αφορά την υλοποίηση των ανωτέρω εργασιών στις κοινές
            όψεις/κοινόχρηστα μέρη του κτιρίου ή επεμβάσεις που επηρεάζουν την
            αισθητική και λειτουργική ενότητα του ακινήτου. Οι εργασίες θα
            εκτελεστούν από εξουσιοδοτημένο μηχανικό σύμφωνα με την πολεοδομική
            νομοθεσία (Ν.4495/2017) και με σεβασμό στην ασφάλεια και στην κοινή
            χρήση του ακινήτου
          </p>
        </div>
      </div>
...
export default FileOneDesignThirteen;
