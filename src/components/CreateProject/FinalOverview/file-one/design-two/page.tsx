// interface ProjectDescriptionTwoProps {
//   address : string;
//   birthDate : string;
//   birthPlace : string;
//   city : string;
...
//             <div className="flex-1 p-2 font-bold">{fatherName || "N/A"}</div>
//           </div>
//         </div>
...
//             <div className="flex-1 p-2 font-bold">{motherName || "N/A"}</div>
//           </div>
//         </div>
...
//             <div className="flex-1 p-2 font-bold">{birthDate || "N/A"}</div>
//           </div>
//         </div>
...
//             <div className="flex-1 p-2 font-bold">{birthPlace || "N/A"}</div>
//           </div>
//         </div>
...
//             <div className="flex-1 p-2 font-bold">{phone || "N/A"}</div>
//           </div>
//         </div>
...
//             <div className="w-26 p-1 border-r border-gray-400 font-bold ">{city || "N/A"}</div>
//             <div className="p-2 border-r border-gray-400 text-sm">Οδός</div>
//             <div className="w-28 p-1 border-r border-gray-400 font-bold ">{address || "A/N"}</div>
...
//             <div className="flex-1 p-1 font-bold">{postalCode || "N/A"}</div>
//           </div>
//         </div>
...
//               </div>
//             </div>
//             <div className="w-32 p-2 underline text-sm flex items-center ml-2">email owner</div>
//           </div>
//         </div>
...
//             <div className="w-39 p-2 font-bold">VAT owner</div>
//             <div className="w-20 p-2 border-l border-gray-400 text-sm border-r">Δ.Ο.Υ.:</div>
    ...
    <div className="max-w-[794px] mx-auto p-4 bg-white">
      ...
      <div className="border border-gray-400">
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            <div className="w-50 p-2 border-r border-gray-400 text-sm">Όνομα και Επώνυμο Πατρός</div>
            <div className="flex-1 p-2 font-bold">Fathers name</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            <div className="w-50 p-2 border-r border-gray-400 text-sm">Όνομα και Επώνυμο Μητρός</div>
            <div className="flex-1 p-2 font-bold">Mothers name</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            <div className="w-50 p-2 border-r border-gray-400 text-sm">Ημερομηνία γέννησης(2):</div>
            <div className="flex-1 p-2 font-bold">Birth day</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            <div className="w-50 p-2 border-r border-gray-400 text-sm">Τόπος Γέννησης</div>
            <div className="flex-1 p-2 font-bold">Birth place</div>
          </div>
        </div>
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            <div className="w-29 p-1 border-r border-gray-400 text-sm">Τόπος κατοικίας</div>
            <div className="w-26 p-1 border-r border-gray-400 font-bold ">City</div>
            <div className="p-2 border-r border-gray-400 text-sm">Οδός</div>
            <div className="w-28 p-1 border-r border-gray-400 font-bold ">Address</div>
            <div className="w-16 p-1 border-r border-gray-400 text-sm">Αριθ</div>
            <div className="w-22 p-1 border-r border-gray-400 font-bold ">Number</div>
            <div className="w-12 p-1 border-r border-gray-400 text-sm">ΤΚ</div>
            <div className="flex-1 p-1 font-bold">PostCode</div>
          </div>
        </div>
