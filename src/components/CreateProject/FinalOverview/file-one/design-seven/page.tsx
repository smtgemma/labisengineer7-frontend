      ...
      <div className="border border-gray-400">
        ...
        <div className="p-4 text-sm">
          ...
          <p className="mb-4">
           ...
           ως κύριος/ιδιοκτήτης του ακινήτου που βρίσκεται επί της οδού ([Address, Number, Town, Postal code], αναθέτω στον/στην Διπλωματούχο Μηχανικό <span className="font-bold">( Engineers Surname  ,  Engineer's Name, Specialty Engineer AM TEE)</span>
          </p>
        ...
        <div className="p-4 text-sm ">
          ...
          <p className="mt-4">
           Η παρούσα ανάθεση αφορά την τεχνική καθοδήγηση και εποπτεία των εργασιών κατά την υλοποίησή τους, την τήρηση των σχετικών κανονισμών ασφαλείας, καθώς και την ευθύνη για την πιστή εφαρμογή του εγκεκριμένου περιεχομένου της άδειας.
          </p>
        </div>
