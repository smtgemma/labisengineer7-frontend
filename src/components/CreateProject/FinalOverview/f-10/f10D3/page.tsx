...
export default function F10D3({ allData }: { allData: allDataProps }) {
        ...
        <div className="max-w-[796px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="space-y-4 text-sm m p-4">
                    <p className="text-sm"> Οι προβλεπόμενες επεμβάσεις δεν θίγουν, δεν επηρεάζουν και δεν επιφέρουν καμία τροποποίηση στον φέροντα οργανισμό (Φ.Ο.) του κτιρίου, όπως αυτός έχει κατασκευαστεί βάσει της εγκεκριμένης οικοδομικής άδειας και των εκάστοτε εγκεκριμένων στατικών </p>
                    <p className="text-sm">Οι επεμβάσεις δεν αντίκεινται σε ειδικότερες διατάξεις, που αφορούν στατικά, πυροπροστασία, υγιεινή, προσβασιμότητα, ενεργειακή απόδοση, προστασία πολιτιστικής κληρονομιάς ή οποιονδήποτε άλλον τομέα ειδικής νομοθεσίας που σχετίζεται με τις κατασκευές.</p>
                </div>
