...
export default function F6D14({ allData, setIsModalOpen }: F6D5Props) {
    ...
    return (
        <div className="max-w-[794px] mx-auto p-6 bg-white arial">
            ...
            <h2 className="text-center font-semibold underline text-xl mb-2">
                ΕΝΗΜΕΡΩΤΙΚΟ ΣΗΜΕΙΩΜΑ ΜΗ ΑΠΑΙΤΗΤΗΣΗΣ ΜΕΛΕΤΗΣ ΠΑΘΗΤΙΚΗΣ ΠΥΡΟΠΡΟΣΤΑΣΙΑΣ
            </h2>
            ...
            <div className="space-y-6 ml-10">
                ...
                <div>
                    ...
                    <p className="text-sm">• Μελέτη παθητικής πυροπροστασίας</p>
                </div>
                <div>
