...
//         try {
//             await updateProject({ projectId: id, userId: createdById, body: data }).unwrap();
//         } catch (error) {
//             console.log(error)
//         }
//         reset()
...
export default function F6D2({ allData, setIsModalOpen }: F6D5Props) {
  const [isEditModalOpen, setIsEditModalOpen] = useState(false)
    ...
    <div className="max-w-[794px] mx-auto p-6 bg-white">
      ...
      <div className="space-y-6 ml-10">
        ...
        <div>
          ...
          <p className="text-sm">• Μελέτη ενεργητικής πυροπροστασίας</p>
        </div>
        <div>
        ...
        <div>
          <h3 className="text-sm font-bold mb-6">
            Τη μελέτη ενεργητικής πυροπροστασίας{" "}
          </h3>
          <p className="text-sm mb-6">
