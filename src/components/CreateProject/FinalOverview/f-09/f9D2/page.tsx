...
export default function F9D2({ allData }: { allData: allDataProps }) {
    ...
    return (
        <div className="max-w-[794px] mx-auto p-6 bg-white">
            ...
            <div className="space-y-6 ml-10">
                <div>
                    <h3 className="text-sm font-bold">●  Λειτουργική Συνένωση Οριζόντιων Ιδιοκτησιών/χώρων
                    </h3>
                    <p className="text-sm mb-6">Η παρέμβαση αφορά τη λειτουργική ενοποίηση δύο υφιστάμενων οριζόντιων ιδιοκτησιών (π.χ. δύο διαμερίσματα ή διαμέρισμα με αποθήκη/βοηθητικό χώρο), που βρίσκονται στον ίδιο όροφο ή σε άλλο επίπεδο και ανήκουν στον ίδιο ιδιοκτήτη/ιδιοκτήτες.
                    </p>
                    <p className="text-sm mb-6">Οι ιδιοκτησίες διατηρούν τις πολεοδομικές τους εγγραφές (σχέδια, χιλιοστά κτλ.) αλλά αποκτούν ενιαία λειτουργική χρήση, χωρίς να απαιτείται σύσταση νέας ιδιοκτησίας ή τροποποίηση οριζοντίου ιδιοκτησίας.</p>
                </div>
                <div>
                ...
                <div>
                    <h3 className="text-sm font-bold">● Τοποθέτηση νέων κουφωμάτων αλουμινίου στα ίδια ανοίγματα
</h3>
                ...
                <div>
                    <h3 className="text-sm font-bold">Ωστόσο, στη συγκεκριμένη περίπτωση, για το σύνολο των προβλεπόμενων εργασιών, διαπιστώνεται ότι οι διαρρυθμίσεις δεν τροποποιούν τις εγκεκριμένες μελέτες του κτιρίου και ιδίως δεν επηρεάζουν:
</h3>
                </div>
                <div>
                    <h3 className="text-sm font-bold">Τη μελέτη ενεργητικής πυροπροστασίας
</h3>
                </div>
                <div>
