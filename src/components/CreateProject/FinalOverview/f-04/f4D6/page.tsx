...
export default function F4D6({ allData }: { allData: allDataProps }) {
          ...
          <h3 className=" text-sm">{owner_name || "N/A"}</h3>
            ...
            <div className="space-y-6 ml-10">
                ...
                <div>
                    ...
                    <p className="text-sm mb-6">Η παρούσα τεχνική έκθεση αφορά τον διαχωρισμό υφιστάμενης ενιαίας Οριζόντιας Ιδιοκτησίας (π.χ. διαμερίσματος, ορόφου ή άλλου λειτουργικού χώρου) σε δύο αυτοτελείς Οριζόντιες Ιδιοκτησίες, οι οποίες θα φέρουν τους νέους χαρακτηρισμούς:
</p>
                    <p className="text-sm mb-6">Ιδιοκτησία Κ1 με Εμβαδόν Εκ1 = …… τ.μ.
</p>
                    <p className="text-sm mb-6">Ιδιοκτησία Κ2 με Εμβαδόν Εκ2 = …… τ.μ.
</p>
                    <p className="text-sm mb-6">Η τροποποίηση της σύστασης οριζόντιας ιδιοκτησίας γίνεται με στόχο την καθαρή οριοθέτηση και νομική διακριτότητα των δύο νέων ιδιοκτησιών, χωρίς να επέρχεται καμία μεταβολή στα κοινόχρηστα ή στον φέροντα οργανισμό του κτιρίου.χωρίς να τροποποιείται ο φέρων οργανισμός, ο όγκος ή η εξωτερική γεωμετρία του κτιρίου, σύμφωνα με τις διατάξεις του άρθρου 29 του Ν.4495/2017 και της ΥΑ ΦΕΚ Β' 1843/2020.
</p>
                    <p className="text-sm mb-6">Η συνένωση αφορά (π.χ. δύο διαμερισμάτων του ιδίου ορόφου / ή χώρων κύριας και βοηθητικής χρήσης που ανήκουν στον ίδιο ιδιοκτήτη).</p>
                </div>
                <div>
                    <h3 className="text-sm font-bold">2. Αναγκαιότητα Εργασιών
</h3>
                    <p className="text-sm mb-6">Οι εργασίες κρίνεται αναγκαίο να υλοποιηθούν προκειμένου να αποκατασταθούν υφιστάμενες φθορές, να βελτιωθούν οι συνθήκες ασφάλειας, υγιεινής και λειτουργικότητας του κτιρίου, να αντιμετωπιστούν ζητήματα ενεργειακής απόδοσης, καθώς και να προσαρμοστούν οι χώροι στις σύγχρονες απαιτήσεις χρήσης, χωρίς επεμβάσεις στον φέροντα οργανισμό ή σε στοιχεία που επηρεάζουν τις όψεις, τηρώντας τις διατάξεις του άρθρου 29 του Ν.4495/2017.</p>
                </div>
                <div>
                    <h3 className="text-sm font-bold">3. Δήλωση Συμμόρφωσης – Πολεοδομική Νομιμότητα
</h3>
                    <p className="text-sm">Δηλώνεται ότι οι προτεινόμενες εργασίες:
</p>
                    <p className="text-sm mb-6">● Δεν θίγουν ή τροποποιούν τον φέροντα οργανισμό του κτιρίου
</p>
                    <p className="text-sm mb-6">● Δεν αυξάνουν τον όγκο, το ύψος ή τη γεωμετρία του κτιρίου
</p>
                    <p className="text-sm mb-6">● Δεν μεταβάλλουν τις όψεις του κτιρίου
</p>
                    <p className="text-sm mb-6">● Δεν παραβιάζουν τις ισχύουσες πολεοδομικές διατάξεις</p>
                </div>
                <div>
                    <h3 className="text-sm font-bold">Εκτελούνται σύμφωνα με το άρθρο 29 του Ν.4495/2017 και το άρθρο 4 της ΥΑ ΦΕΚ Β’ 1843/2020.</h3>
                </div>
                {/* {/* Signature Section */}
