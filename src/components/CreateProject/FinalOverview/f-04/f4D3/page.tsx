...
export default function F4D3({ allData }: { allData: allDataProps }) {
  ...
  return (
    <div className="max-w-[794px] mx-auto p-6 bg-white">
      ...
      <div className="space-y-6 ml-10">
        ...
        <div>
          <h3 className="text-sm font-bold underline">Συνεπώς, δεν απαιτείται σύγκληση ή απόφαση γενικής συνέλευσης ή άλλη μορφή συναίνεσης των υπολοίπων συνιδιοκτητών, για την εκτέλεση των εν λόγω εργασιών.</h3>
          <p className="text-sm mb-6">
