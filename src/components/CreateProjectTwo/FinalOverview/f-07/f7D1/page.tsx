...
export default function F7D1({ allData }: { allData: allDataProps }) {
    const {
        owner_address,
        owner_afm,
        owner_birth_date,
        ...
        <div className="max-w-[796px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="space-y-4 text-sm m p-4">
                    <p className="mb-6">Δεν υφίσταται αλλοίωση των εξωτερικών όψεων του κτιρίου·
                    </p>
                    <p className="mb-6">Δεν πραγματοποιούνται επεμβάσεις σε φέροντα στοιχεία τόσο των όψεων όσο και του συνολικού φέροντος οργανισμού·
                    </p>
                    <p className="mb-6">Οι προβλεπόμενες εργασίες είναι συμβατές με τις ισχύουσες πολεοδομικές διατάξεις και δεν παραβιάζουν καθορισμένα πολεοδομικά μεγέθη (ύψος, κάλυψη, δόμηση κ.λπ.).
                    </p>
                    <p className="mb-6">Η παρούσα βεβαίωση εκδίδεται για κάθε νόμιμη χρήση στο πλαίσιο των διατάξεων του Ν.4495/2017 και της κείμενης πολεοδομικής νομοθεσίας.</p>
                </div>
