...
export default function F3D5({ allData }: { allData: allDataProps }) {
  const {
    owner_address,
    owner_afm,
    owner_birth_date,
      ...
      <div className="border border-gray-400">
        ...
        <div className="border-b border-gray-400">
          <div className="flex">
            ...
            <div className="w-32 p-2 underline ">
              {owner_email || "N/A"}
            </div>
          </div>
        </div>
        ...
        <div className="p-4 text-sm">
          <p className="mb-4">
            Με ατομική μου ευθύνη και γνωρίζοντας τις κυρώσεις(3), που προβλέπονται
            από τις διατάξεις της παρ. 6 του άρθρου 22 του Ν.1599/1986, δηλώνω ότι:
          </p>

          <p className="mb-4">
            ότι εφαρμόζοντας τις ισχύουσες γενικές και ειδικές πολεοδομικές
            διατάξεις <span className="text-sm font-bold">αναλαμβάνω</span> για το
            έργο
          </p>
        ...
        <div className="p-4 text-sm ">
          <p>
            ...
            διατάξεις και ειδικότερα τις προβλέψεις του άρθρου 29 του Ν.4495/2017.
          </p>
        </div>
        <div className="p-4 text-sm ">
          <p>
            ...
            ασφαλείας, καθώς και την ευθύνη για την πιστή εφαρμογή του εγκεκριμένου
            περιεχομένου της άδειας.
          </p>
        </div>
          ...
          <div className="flex justify-end p-4">
            <div className="text-right space-y-2">
              <div className="flex items-center gap-4">
                ...
                <span className="text-sm font-medium">8/25/2025</span>
              </div>
