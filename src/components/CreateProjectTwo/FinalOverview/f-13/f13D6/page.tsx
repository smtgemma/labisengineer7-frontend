...
export default function F13D6({ allData }: { allData: allDataProps }) {
    const {
        owner_address,
        owner_afm,
        owner_birth_date,
        ...
        <div className="max-w-[794px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm space-y-6">
                    <p>
                        -Δεν θίγεται ο φέρων οργανισμός του υφιστάμενου κτιρίου, καθώς η δεξαμενή αποτελεί ανεξάρτητη κατασκευή εντός του οικοπέδου.
                    </p>

                    <p>
                        -Τηρούνται όλες οι ισχύουσες πολεοδομικές διατάξεις, συμπεριλαμβανομένων των διατάξεων για τις
                        αποστάσεις από τα όρια, τον κοινόχρηστο χώρο, καθώς και τις απαιτήσεις κάλυψης και δόμησης, σύμφωνα με τον ισχύοντα ΓΟΚ / ΝΟΚ.
                    </p>

                    <p>
                        -Η κατασκευή της δεξαμενής πληροί τις απαιτήσεις στατικής επάρκειας και ασφάλειας, βάσει σχετικής στατικής μελέτης ή/και
                        προδιαγραφών.
                    </p>

                    <p>
                        -Τηρούνται οι απαιτήσεις της ισχύουσας Υγειονομικής Νομοθεσίας, όσον αφορά τον τρόπο τροφοδότησης, την αποχέτευση, τον εξαερισμό
                        του μηχανοστασίου και τη διασφάλιση της ποιότητας του νερού της δεξαμενής.
                    </p>

                    <p>
                        -Έχουν ληφθεί υπόψη οι διατάξεις προστασίας υπεδάφους και υφισταμένων υποδομών, καθώς και οι οποιεσδήποτε υποχρεώσεις
                        αρχαιολογικού ενδιαφέροντος, όπου υφίστανται.
                    </p>
                    <p className="font-bold">
                        Η παρούσα δήλωση εκδίδεται για την κάλυψη των απαιτήσεων του άρθρου 4 της ΥΑ ΦΕΚ Β’ 1843/2020, προκειμένου να συνοδεύσει
                        τον φάκελο Άδειας Μικρής Κλίμακας για το έργο.
                    </p>
                </div>
