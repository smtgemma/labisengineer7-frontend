...
export default function F4D9({ allData }: { allData: allDataProps }) {
  const {
    owner_address,
    owner_afm,
    owner_birth_date,
        ...
        <div className="max-w-[796px] mx-auto bg-white">
            ...
            <div className="border border-gray-400">
                ...
                <div className="p-4 text-sm">
                    ...
                    <p className=" text-sm">ότι εφαρμόζοντας τις ισχύουσες γενικές και ειδικές πολεοδομικές διατάξεις αναλαμβάνω για το έργο</p>
