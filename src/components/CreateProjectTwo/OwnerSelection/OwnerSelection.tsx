...
const properties: Property[] = [
  {
    title: "Property 1",
    description:
      "Οριζόντια ιδιοκτησία-Η υπό στοιχεια άλφα πι κεφαλαιαα δύο αποθήκη του υπογείουΟριζόντια ιδιοκτησία-Η υπό στοιχεια άλφα πι κεφαλαιαα δύο αποθήκη του υπογείου",
  },
  {
    title: "Property 2",
    description:
      "Οριζόντια ιδιοκτησία-Η υπό στοιχεια άλφα πι κεφαλαιαα δύο αποθήκη του υπογείου Οριζόντια ιδιοκτησία-Η υπό στοιχεια άλφα πι κεφαλαιαα δύο αποθήκη του υπογείου",
  },
];
...
const OwnerSelection = () => {
  ...
  const togglePropertySelection = (index: number) => {
    ...
    const alreadySelected = selectedProperty.some(
      (o) => o.title === property.title
    );

    if (alreadySelected) {
      // if already selected → remove it
      setSelectedProperty(
        selectedProperty.filter((o) => o.title !== property.title)
      );
    } else {
      // otherwise add it
      setSelectedProperty([
  ...
  console.log("new", selectedProperty);
  ...
  return (
    ...
    ${
      selectedProperty?.some((o) => o.title === property.title)
