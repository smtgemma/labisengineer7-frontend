...
export default function F4D2({ allData }: { allData: allDataProps }) {
    ...
    return (
        <div className="max-w-[794px] mx-auto p-6 bg-white">
            ...
            <div className="space-y-6 ml-10">
                ...
                <div>
                    <p className="text-sm mb-6">
                       Για το σύνολο των προβλεπόμενων εργασιών που πρόκειται να εκτελεστούν στην εν λόγω ιδιοκτησία, δεν απαιτείται η προσκόμιση συμβολαιογραφικής δήλωσης δέσμευσης θέσης στάθμευσης.
                    </p>
                    <p className="text-sm mb-6">
                       Η απαλλαγή αυτή τεκμηριώνεται από το γεγονός ότι:
                    </p>
                    <p className="text-sm mb-6">
                       Με βάση τα εγκεκριμένα σχέδια της οικοδομικής άδειας, την ισχύουσα σύσταση οριζοντίου ιδιοκτησίας και τα συμβόλαια του ακινήτου, στην υφιστάμενη οριζόντια ιδιοκτησία ΔΕΝ υφίστατο θέση στάθμευσης ούτε με μορφή αποκλειστικής χρήσης, ούτε ως αυτοτελής ιδιοκτησία.
                    </p>
                    <p className="text-sm">
                       Κατά συνέπεια:
                    </p>
                    <p className="text-sm">
                       Ο διαχωρισμός της οριζόντιας ιδιοκτησίας (σε Κ1 και Κ2) δεν επηρεάζει καθ’ οιονδήποτε τρόπο θέσεις στάθμευσης
                    </p>
                    <p className="text-sm">
                       Δεν απαιτείται τροποποίηση της σύστασης οριζοντίου ιδιοκτησίας σχετικά με χώρους στάθμευσης
                    </p>
                    <p className="text-sm">
                       Η παρούσα δήλωση παρέχεται αποκλειστικά για χρήση στο πλαίσιο της αδειοδοτικής διαδικασίας ή/και έναντι οποιασδήποτε 
                    </p>
                    <p className="text-sm">
                       αρμόδιας αρχής (π.χ. Πολεοδομία, Συμβολαιογράφος)
                    </p>
                    <p className="text-sm">
                       Συνεπώς, δεν υφίσταται υποχρέωση υποβολής συμβολαιογραφικής πράξης ή δήλωσης για τη δέσμευση ή παραχώρηση θέσης στάθμευσης.
                    </p>
                    <p className="text-sm mt-6">
                       Η παρούσα δήλωση εκδίδεται για την τεκμηρίωση του φακέλου εργασιών, στο πλαίσιο της τήρησης των διατάξεων του Ν.4495/2017 και των σχετικών κανονιστικών πράξεων.
                    </p>
                </div>
                <div>
                    <p className="text-sm mb-6">
