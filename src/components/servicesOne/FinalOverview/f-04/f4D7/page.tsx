...
export default function F4D7({ allData }: { allData: allDataProps }) {
  const {
    owner_address,
    owner_city,
    owner_name,
    ...
    return (
        <div className="max-w-[794px] mx-auto p-6 bg-white">
            ...
            <div className="space-y-6 ml-10">
                <div>
                    <h3 className="text-sm font-bold">● Διαχωρισμός υφιστάμενης Οριζόντιας Ιδιοκτησίας σε δύο νέες Οριζόντιες Ιδιοκτησίες Κ1 και Κ2
                    </h3>
                    <p className="text-sm mb-6">Διαχωρισμός υφιστάμενης ενιαίας Οριζόντιας Ιδιοκτησίας (π.χ. διαμερίσματος, ορόφου ή άλλου λειτουργικού χώρου) σε δύο αυτοτελείς Οριζόντιες Ιδιοκτησίες, οι οποίες θα φέρουν τους νέους χαρακτηρισμούς:
                    </p>
                    <p className="text-sm mb-6">Ιδιοκτησία Κ1 με Εμβαδόν Εκ1 = …… τ.μ.
                    </p>
                    <p className="text-sm mb-6">Ιδιοκτησία Κ2 με Εμβαδόν Εκ2 = …… τ.μ.
                    </p>
