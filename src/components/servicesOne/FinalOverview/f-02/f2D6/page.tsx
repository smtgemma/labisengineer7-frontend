...
export default function F2D6({ allData, ownerIndex }: { allData: allDataProps, ownerIndex: number }) {
                        ...
                        <div className="p-4 text-sm">
                            ...
                            <span className="mb-4">
                                ...
                                αναθέτω στον/στην Διπλωματούχο Μηχανικό
                                 {engineers[0]?.lastName || "N/A"}, {engineers[0]?.firstName || "N/A"}, {engineers[0]?.specialty || "N/A"} {engineers[0]?.teeNumber || "N/A"}
                            </span>
