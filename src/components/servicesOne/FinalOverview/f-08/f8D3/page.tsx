                    ...
                    <div className="border border-gray-400">
                        ...
                        <div className="p-4 text-sm">
                            ...
                            <span className="mb-4">
                                ...
                                <span className="font-bold ml-1">{engineers[0]?.lastName || "N/A"}, {engineers[0]?.firstName || "N/A"}, {engineers[0]?.specialty || "N/A"},</span> με Α.Μ ΤΕΕ : <span className="font-bold">{engineers[0]?.teeNumber}</span>
                            </span>
