...
function F7D10({ allData }: { allData: allDataProps }) {
    ...
    const { propertyPlace, propertyAddress, propertyPostalCode, propertyNumber, municipalityCommunity, projectDescriptions, serviceId, id, createdById } = allData || {};
