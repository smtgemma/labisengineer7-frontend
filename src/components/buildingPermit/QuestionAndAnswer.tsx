    ...
    const [questions, setQuestions] = useState<Question[]>([
        {
            ...
            options: [
                { id: '1a', text: 'Ναι, όπως στον 2ο - 3ο ορ. μ΄ εύρημα που επεκρατεί η τοιχοποιία, είτε στον ορόφου όπου η επι ατομικής δωματίου είτε στο ακάθ σροος όπως τα χωρουργία είτε σε δωμάτιον στο πατάματος' },
                { id: '1b', text: 'Ναι, ιμοντώ το περίσσουμα της βλαχτίκαιτε, πατήτρικα να αυτό τις ασιτιατοις ακαάυλευτος βλαχτικαίς (Ε.Ο.Τ)' },
                { id: '1c', text: 'Όχι όλα είναι τον 2 ης αιω παρασκευός η προσπάθειας στο ορόφου \'In Rep 1 τον υ Σ4202026.' },
        ...
        },
        {
            ...
            options: [
                { id: '2a', text: 'Ναι, όπως στον 2ο - 3ο ορ. μ΄ εύρημα που επεκρατεί η τοιχοποιία, είτε στον ορόφου όπου η επι ατομικής δωματίου είτε στο ακάθ σροος όπως τα χωρουργία είτε σε δωμάτιον στο πατάματος' },
                { id: '2b', text: 'Ναι, ιμοντώ είναι στου 3 ης αιω παρασκευός η προσπάθειας στο ορόφου \'In Rep 1 τον υ Σ4202026.' },
                { id: '2c', text: 'Ναι, ιμοντώ το περίσσουμα της βλαχτίκαιτε, πατήτρικα να αυτό τις ασιτιατοις ακαάυλευτος βλαχτικαίς (Ε.Ο.Τ)' },
        ...
        },
        {
            ...
            options: [
                { id: '3a', text: 'Ναι, όπως στον 2ο - 3 ως το στεγνούμενα της βλαχτικαιτε εντι βασιχξίσα να αυτό τις ασιτιατοις ακαάυλευτος βλαχτικαίς (Ε.Ο.Τ)' },
                { id: '3b', text: 'Ναι, ιμοντώ είναι στου 3 ης αιω παρασκευός η προσπάθειας στο ορόφου \'In Rep 1 τον υ Σ4202026.' },
                { id: '3c', text: 'Ναι, ιμοντώ το περίσσουμα της βλαχτίκαιτε, πατήτρικα να αυτό τις ασιτιατοις ακαάυλευτος βλαχτικαίς (Ε.Ο.Τ)' },
        ...
        },
        {
            ...
            options: [
                { id: '4a', text: 'Ναι υπάρχει' },
                { id: '4b', text: 'Όχι δεν υπάρχει' }
            ],
            selectedOption: null
        }
    ]);
