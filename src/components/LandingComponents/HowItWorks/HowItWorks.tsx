...
import VerticalStepLine from "./WorksCard/VerticalLine";
...
export default function HowItWorks() {
  return (
    ...
    >
      <h2 className="text-2xl md:text-3xl lg:text-5xl font-bold text-center text-primary mb-8 md:mb-12 pt-[60px] md:pt-[100px] px-4">
        How It Works
      </h2>

      {/* Wrapper that controls the line height */}
      <div className="relative w-full flex flex-col gap-8 md:gap-20 items-start">
        <VerticalStepLine steps={7} />
