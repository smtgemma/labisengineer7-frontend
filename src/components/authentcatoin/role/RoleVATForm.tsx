...
export default function RoleVATForm() {
  const {
    register,
    handleSubmit,
    formState: { errors },
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          <div>
            ...
            >
              ...
              <option value="BuildAI Ltd.">BuildAI Ltd.</option>
              <option value="TechEdge Solutions">TechEdge Solutions</option>
              <option value="SmartConstruct Inc.">SmartConstruct Inc.</option>
              <option value="InfraDesign Group">InfraDesign Group</option>
              <option value="NextGen Builders">NextGen Builders</option>
            </select>
            {errors.userType && (
