        ...
        <footer className="">
          <div className=" mx-auto grid grid-cols-1 md:flex md:justify-between gap-10">
            ...
            <div className="col-span-1 md:col-span-2 flex flex-col gap-4">
              ...
              <p className=" text-2xl md:text-[32px] font-medium">
                JOIN THE COMMUNITY
              </p>
            ...
            {/* Quick Share */}
            <div>
              <h3 className="font-semibold text-base md:text-2xl mb-2">
                Quick Share
              </h3>
            ...
            {/* Policy */}
            <div>
              <h3 className="font-semibold text-base md:text-2xl text-gray-900 mb-2">
                Policy
              </h3>
              <ul className="space-y-2 text-sm text-gray-900 md:text-[18px]">
                <li>
